		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td>{addressDriverClient?.networkConfig?.CONTRACT_DRIPS_HUB || '[Not Connected]'}</td>
				</tr>
				<tr>
					<th>AddressDriver Contract</th>
					<td>{addressDriverClient?.networkConfig?.CONTRACT_ADDRESS_DRIVER || '[Not Connected]'}</td>
				</tr>
				<tr>
					<th>AddressAppLogic Contract</th>
					<td>{addressDriverClient?.networkConfig?.CONTRACT_ADDRESS_DRIVER_LOGIC || '[Not Connected]'}</td>
				</tr>
				<tr>
					<th>DripbHubLogic Contract</th>
					<td>{addressDriverClient?.networkConfig?.CONTRACT_DRIPS_HUB_LOGIC || '[Not Connected]'}</td>
				</tr>
				<tr>
					<th>Subgraph URL</th>
