...
import type { DaiDripsHub, DaiDripsHubInterface } from "../DaiDripsHub";
...
export class DaiDripsHub__factory {
  static readonly abi = _abi;
  static createInterface(): DaiDripsHubInterface {
    return new utils.Interface(_abi) as DaiDripsHubInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DaiDripsHub {
    return new Contract(address, _abi, signerOrProvider) as DaiDripsHub;
  }
}
