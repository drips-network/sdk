...
function buildTx(request) {
  const callData = viem.encodeFunctionData(request);
  return {
...
function parseStreamRate(amount, timeUnit, tokenDecimals) {
  ...
  const amountWithPrecision = viem.parseUnits(amount, totalDecimals);
...
function resolveAddressFromAddressDriverId(accountId) {
  ...
  return viem.checksumAddress(addressHex);
}
...
async function calcRepoDriverAccountId(adapter, params) {
  ...
  const calcAccountIdTx = buildTx({
    ...
    args: [forgeMap[forge], viem.toHex(name)]
  });
  const encodedResult = await adapter.call(calcAccountIdTx);
  const accountId = viem.decodeFunctionResult({
    abi: repoDriverAbi,
    functionName: "calcAccountId",
    data: encodedResult
  });
...
function destructProjectUrl(url) {
  ...
  return {
    forge: "github",
    // TODO: refactor when supporting more forges
    ownerName,
    repoName
  };
}
...
var SANDBOX_PREFIX = "sandbox-";
var SANDBOX_PREFIX_REGEX = new RegExp(`^${SANDBOX_PREFIX}`);
function unprefixOrcidId(orcidId) {
  return orcidId.replace(SANDBOX_PREFIX_REGEX, "");
}
var ORCID_BASE_FORMAT_REGEX = /^\d{15}[\dX]$/i;
var ORCID_DISPLAY_FORMAT_REGEX = /^\d{4}-\d{4}-\d{4}-\d{3}[\dX]$/;
function assertValidOrcidId(orcidId) {
  ...
  const baseStr = unprefixedOrcidId.replace(/[-\s]/g, "");
...
async function calcDripListId(adapter, params) {
  ...
  const dripListId = viem.decodeFunctionResult({
    abi: nftDriverAbi,
    functionName: "calcTokenIdWithSalt",
    data: encodedResult
  });
...
function createViemWriteAdapter(walletClient) {
  ...
  const publicClient = walletClient.extend(viem.publicActions);
  return {
...
function encodeMetadataKeyValue({
  ...
  const encodedKey = viem.pad(viem.toHex(keyBytes), { size: 32, dir: "right" });
  return {
    key: encodedKey,
    value: viem.stringToHex(value)
  };
}
...
function createGraphQLClient(url = DEFAULT_GRAPHQL_URL, apiKey) {
  ...
  const client = new graphqlRequest.GraphQLClient(url, { headers });
  return {
...
var GET_DRIP_LIST_QUERY = graphqlRequest.gql`
...
var GET_CURRENT_STREAM_RECEIVERS_QUERY = graphqlRequest.gql`
...
var streamConfigSchema = z6.z.object({
   ...
   * start date.
   */
  startTimestamp: z6.z.number().optional()
});
var dripsUserSchema = z6.z.object({
  driver: z6.z.union([z6.z.literal("address"), z6.z.literal("nft"), z6.z.literal("repo")]),
  accountId: z6.z.string()
});
var streamMetadataSchema = z6.z.object({
  id: z6.z.string(),
  initialDripsConfig: streamConfigSchema,
  receiver: dripsUserSchema,
  archived: z6.z.boolean(),
  name: z6.z.string().optional(),
  description: z6.z.string().optional()
});
var assetConfigMetadataSchema = z6.z.object({
  tokenAddress: ethAddressSchema,
  streams: z6.z.array(streamMetadataSchema)
});
var addressDriverAccountMetadataSchemaV1 = z6.z.object({
  describes: z6.z.object({
    driver: z6.z.literal("address"),
    accountId: z6.z.string()
  }),
  name: z6.z.string().optional(),
  description: z6.z.string().optional(),
  emoji: z6.z.string().optional(),
  assetConfigs: z6.z.array(assetConfigMetadataSchema),
  timestamp: z6.z.number(),
  writtenByAddress: ethAddressSchema
});
var gitHubSourceSchema = z6.z.object({
  forge: z6.z.literal("github"),
  repoName: z6.z.string(),
  ownerName: z6.z.string(),
  url: z6.z.string()
});
var sourceSchema = gitHubSourceSchema;

// src/internal/metadata/schemas/repo-driver/v2.ts
var addressDriverSplitReceiverSchema = z6.z.object({
  type: z6.z.literal("address"),
  weight: z6.z.number(),
  accountId: z6.z.string()
});
var repoDriverSplitReceiverSchema = z6.z.object({
  type: z6.z.literal("repoDriver"),
  weight: z6.z.number(),
  accountId: z6.z.string(),
  source: sourceSchema
});
var repoDriverAccountSplitsSchema = z6.z.object({
  maintainers: z6.z.array(addressDriverSplitReceiverSchema),
  dependencies: z6.z.array(
    z6.z.union([repoDriverSplitReceiverSchema, addressDriverSplitReceiverSchema])
  )
});
var repoDriverAccountMetadataSchemaV2 = z6.z.object({
  driver: z6.z.literal("repo"),
  describes: z6.z.object({
    driver: z6.z.literal("repo"),
    accountId: z6.z.string()
  }),
...
var addressDriverSplitReceiverSchema2 = z6.z.object({
  type: z6.z.literal("address"),
  weight: z6.z.number(),
  accountId: z6.z.string()
});
var repoDriverSplitReceiverSchema2 = z6.z.object({
  type: z6.z.literal("repoDriver"),
  weight: z6.z.number(),
  accountId: z6.z.string(),
  source: sourceSchema
});
var dripListSplitReceiverSchema = z6.z.object({
  type: z6.z.literal("dripList"),
  weight: z6.z.number(),
  accountId: z6.z.string()
});
var nftDriverAccountMetadataSchemaV2 = z6.z.object({
  driver: z6.z.literal("nft"),
  describes: z6.z.object({
    driver: z6.z.literal("nft"),
    accountId: z6.z.string()
  }),
  isDripList: z6.z.literal(true),
  projects: z6.z.array(
    z6.z.union([
...
var repoSubAccountDriverSplitReceiverSchema = z6__default.default.object({
  type: z6__default.default.literal("repoSubAccountDriver"),
  weight: z6__default.default.number(),
  accountId: z6__default.default.string(),
  source: sourceSchema
});

// src/internal/metadata/schemas/immutable-splits-driver/v1.ts
var subListSplitReceiverSchema = z6__default.default.object({
  type: z6__default.default.literal("subList"),
  weight: z6__default.default.number(),
  accountId: z6__default.default.string()
});
var subListMetadataSchemaV1 = z6__default.default.object({
  driver: z6__default.default.literal("immutable-splits"),
  type: z6__default.default.literal("subList"),
  recipients: z6__default.default.array(
  ...
  parent: z6__default.default.object({
    accountId: z6__default.default.string(),
    driver: z6__default.default.union([z6__default.default.literal("nft"), z6__default.default.literal("immutable-splits")]),
    type: z6__default.default.union([
      z6__default.default.literal("dripList"),
      z6__default.default.literal("ecosystem"),
      z6__default.default.literal("subList")
    ])
  }),
  root: z6__default.default.object({
    accountId: z6__default.default.string(),
    driver: z6__default.default.union([z6__default.default.literal("nft"), z6__default.default.literal("immutable-splits")]),
    type: z6__default.default.union([
      z6__default.default.literal("dripList"),
...
var addressDriverSplitReceiverSchema3 = z6.z.object({
  weight: z6.z.number(),
  accountId: z6.z.string()
});
var repoDriverSplitReceiverSchema3 = z6.z.object({
  weight: z6.z.number(),
  accountId: z6.z.string(),
  source: sourceSchema
});
var nftDriverAccountMetadataSchemaV1 = z6.z.object({
  driver: z6.z.literal("nft"),
  describes: z6.z.object({
    driver: z6.z.literal("nft"),
    accountId: z6.z.string()
  ...
  isDripList: z6.z.literal(true),
  projects: z6.z.array(
    z6.z.union([repoDriverSplitReceiverSchema3, addressDriverSplitReceiverSchema3])
  ),
  name: z6.z.string().optional()
});
...
var nftDriverAccountMetadataSchemaV4 = nftDriverAccountMetadataSchemaV3.extend({
  latestVotingRoundId: z6.z.string().optional()
});
var nftDriverAccountMetadataSchemaV5 = nftDriverAccountMetadataSchemaV4.extend({
  isVisible: z6.z.boolean()
});
var dripListSplitReceiverSchema2 = z6.z.object({
  type: z6.z.literal("dripList"),
  weight: z6.z.number(),
  accountId: z6.z.string()
});
var repoDriverAccountSplitsSchema2 = z6.z.object({
  maintainers: z6.z.array(addressDriverSplitReceiverSchema),
  dependencies: z6.z.array(
    z6.z.union([
...
var emojiAvatarSchema = z6.z.object({
  type: z6.z.literal("emoji"),
  emoji: z6.z.string()
});
var imageAvatarSchema = z6.z.object({
  type: z6.z.literal("image"),
  cid: z6.z.string()
});
var repoDriverAccountMetadataSchemaV4 = repoDriverAccountMetadataSchemaV3.extend({
  emoji: z6.z.undefined().optional(),
  avatar: z6.z.union([emojiAvatarSchema, imageAvatarSchema])
});
...
var base = nftDriverAccountMetadataSchemaV5.omit({
  ...
  isDripList: z6.z.undefined().optional(),
  projects: z6.z.undefined().optional()
});
var ecosystemVariant = base.extend({
  type: z6.z.literal("ecosystem"),
  recipients: z6.z.array(
    z6.z.union([
      repoSubAccountDriverSplitReceiverSchema,
      subListSplitReceiverSchema
    ])
...
var nftDriverAccountMetadataSchemaV6 = z6.z.discriminatedUnion("type", [
  ecosystemVariant,
  dripListVariant
]);
var addressDriverSplitReceiverSchema4 = z6.z.object({
  weight: z6.z.number(),
  accountId: z6.z.string()
});
var repoDriverSplitReceiverSchema4 = z6.z.object({
  weight: z6.z.number(),
  accountId: z6.z.string(),
  source: sourceSchema
});
var repoDriverAccountSplitsSchema3 = z6.z.object({
  maintainers: z6.z.array(addressDriverSplitReceiverSchema4),
  dependencies: z6.z.array(
    z6.z.union([repoDriverSplitReceiverSchema4, addressDriverSplitReceiverSchema4])
  )
});
var repoDriverAccountMetadataSchemaV1 = z6.z.object({
  driver: z6.z.literal("repo"),
  describes: z6.z.object({
    driver: z6.z.literal("repo"),
    accountId: z6.z.string()
...
var orcidSplitReceiverSchema = z6__default.default.object({
  type: z6__default.default.literal("orcid"),
  weight: z6__default.default.number(),
  accountId: z6__default.default.string(),
  orcidId: z6__default.default.string()
});
var repoDriverAccountSplitsSchema4 = z6__default.default.object({
  maintainers: z6__default.default.array(addressDriverSplitReceiverSchema),
  dependencies: z6__default.default.array(
    z6__default.default.union([
      dripListSplitReceiverSchema,
      repoDriverSplitReceiverSchema,
      addressDriverSplitReceiverSchema,
...
var repoDriverAccountMetadataSchemaV6 = repoDriverAccountMetadataSchemaV5.extend({
  splits: repoDriverAccountSplitsSchema4
});

// src/internal/metadata/schemas/nft-driver/v7.ts
var base2 = nftDriverAccountMetadataSchemaV5.omit({
  isDripList: true,
  projects: true
}).extend({
  allowExternalDonations: z6.z.boolean().optional()
});
var ecosystemVariant2 = base2.extend({
  type: z6.z.literal("ecosystem"),
  recipients: z6.z.array(
    z6.z.union([
      repoSubAccountDriverSplitReceiverSchema,
...
var dripListVariant2 = base2.extend({
  type: z6.z.literal("dripList"),
  recipients: z6.z.array(
    z6.z.union([
      repoDriverSplitReceiverSchema,
...
var nftDriverAccountMetadataSchemaV7 = z6.z.discriminatedUnion("type", [
  ecosystemVariant2,
  dripListVariant2
]);

// src/internal/metadata/schemas/index.ts
var nftDriverAccountMetadataParser = versionedParser.createVersionedParser([
...
var addressDriverAccountMetadataParser = versionedParser.createVersionedParser([
  addressDriverAccountMetadataSchemaV1.parse
]);
var repoDriverAccountMetadataParser = versionedParser.createVersionedParser([
...
var immutableSplitsDriverMetadataParser = versionedParser.createVersionedParser([
...
async function prepareContinuousDonation(adapter, ipfsMetadataUploaderFn, donation, graphqlClient) {
  ...
  const setStreamsTx = buildTx({
    ...
    args: [
      erc20,
      currentReceivers,
      viem.parseUnits(topUpAmount ?? "0", tokenDecimals),
      newReceivers,
      0,
      0,
      signerAddress
...
async function prepareOneTimeDonation(adapter, donation) {
  ...
  const amountInWei = viem.parseUnits(amount, tokenDecimals);
...
var GET_USER_WITHDRAWABLE_BALANCES_QUERY = graphqlRequest.gql`
...
function createPinataIpfsMetadataUploader({
  ...
  const pinata$1 = new pinata.PinataSDK({
    pinataJwt,
    pinataGateway
  });
  const client = {
    uploadJson: async (data) => {
      ...
      const { cid } = await pinata$1.upload.public.json(jsonSafeData);
      return { cid };
    }
  };
...
exports.prepareDripListUpdate = prepareDripListUpdate;
exports.prepareOneTimeDonation = prepareOneTimeDonation;
exports.sendContinuousDonation = sendContinuousDonation;
