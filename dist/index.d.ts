...
import { B as BatchedTxOverrides, P as PreparedTx, R as ReadBlockchainAdapter, W as WriteBlockchainAdapter, T as TxResponse } from './BlockchainAdapter-Dt3QuYIj.js';
export { a as TxReceipt } from './BlockchainAdapter-Dt3QuYIj.js';
...
declare const nftDriverAccountMetadataParser: _efstajas_versioned_parser.Parser<[(data: unknown, params?: z.util.InexactPartial<z.ParseParams>) => {
    ...
    allowExternalDonations?: boolean | undefined;
} | {
    type: "dripList";
    driver: "nft";
    describes: {
...
declare const contractsRegistry: {
    readonly 1: {
        ...
        readonly nativeTokenUnwrapper: {
            readonly address: "0xa4d564894eb4b318e06adbc284295b6597a22019";
        };
    };
    readonly 80002: {
        readonly repoDriver: {
    ...
    readonly 11155420: {
        readonly repoDriver: {
            readonly address: "0x808e5C413BB085284D18e17BDF9682A66A0097D5";
        };
        readonly nftDriver: {
            readonly address: "0x299E6caA0f682AE8ce4Cae83BaF70c271cDC7e6C";
        };
        readonly addressDriver: {
            readonly address: "0xA2B5b1ACaF088d6AF2e289EF54DbF48058429eA8";
        };
        readonly drips: {
            readonly address: "0xa15f3ebCf1e9c83442ddFa92A2A44A3d1643E406";
        };
        readonly caller: {
            readonly address: "0x2ff2bDEfB8Bb4675fB62936Cd9971Ca349aC81a2";
        };
        readonly nativeTokenUnwrapper: {
            readonly address: "0x0288C45cA3ae6d226f3fCC45c340A13914f0FaF2";
        };
    };
    readonly 11155111: {
        readonly repoDriver: {
        ...
        readonly nativeTokenUnwrapper: {
            readonly address: "0xf470601db8f7eebac6612a16bf15daed0f414f6a";
        };
    };
    readonly 31337: {
        readonly repoDriver: {
