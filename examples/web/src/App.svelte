<script lang="ts">
	...
	const networks = {
		1: {
			name: 'mainnet',
			layer: 'ethereum',
			infura: 'wss://mainnet.infura.io/ws/v3/1cf5614cae9f49968fe604b818804be6',
			explorer: { name: 'Etherscan', domain: 'https://etherscan.io' },
			subgraph: 'https://api.thegraph.com/subgraphs/name/gh0stwheel/drips-on-mainnet'
		},
		4: {
			name: 'rinkeby',
			layer: 'ethereum',
			infura: 'wss://rinkeby.infura.io/ws/v3/1cf5614cae9f49968fe604b818804be6',
			explorer: { name: 'Etherscan', domain: 'https://rinkeby.etherscan.io' },
			subgraph: 'https://api.thegraph.com/subgraphs/name/gh0stwheel/drips-on-rinkeby'
		},
		137: {
			name: 'matic',
			layer: 'polygon',
			infura: 'https://polygon-mainnet.infura.io/v3/1cf5614cae9f49968fe604b818804be6',
			explorer: { name: 'Polyscan', domain: 'https://polygonscan.com' },
			subgraph: 'https://api.thegraph.com/subgraphs/name/gh0stwheel/drips-on-polygon'
		},
		80001: {
			name: 'mumbai',
			layer: 'polygon',
			infura: 'https://polygon-mumbai.infura.io/v3/1cf5614cae9f49968fe604b818804be6',
			explorer: { name: 'Polyscan', domain: 'https://mumbai.polygonscan.com' },
			subgraph: 'https://api.thegraph.com/subgraphs/name/gh0stwheel/drips-on-mumbai'
		}
	};
