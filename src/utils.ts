	...
	export namespace Network {
		export const configs: Record<number, NetworkConfig> = {
			...
			80002: {
				...
				REPO_DRIVER_ADMIN: '0x341a08926dCa7fa7D135F96E4d76b696e5f6d38d',
				SUBGRAPH_URL: 'https://api.studio.thegraph.com/query/47690/drips-on-amoy/version/latest'
			},
			// Optimism Sepolia
			11155420: {
				...
				REPO_DRIVER_LOGIC: '0x7A9a2a29B8d98922Ea2E70c73B123e36C95d1515',
				REPO_DRIVER_ADMIN: '0x341a08926dCa7fa7D135F96E4d76b696e5f6d38d',
				SUBGRAPH_URL: 'https://api.studio.thegraph.com/query/47690/drips-on-optimism-sepolia/version/latest'
			},
			// Base Sepolia
			84532: {
				CHAIN: 'base-sepolia',
				...
				REPO_DRIVER_LOGIC: '0x7C6cCB07A4Cc03e3873E8CD1E7f3633a11f6AcF7',
				REPO_DRIVER_ADMIN: '0x341a08926dCa7fa7D135F96E4d76b696e5f6d38d',
				SUBGRAPH_URL: 'https://api.studio.thegraph.com/query/47690/drips-on-base-sepolia/version/latest'
			}
		};
