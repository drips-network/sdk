...
describe('AddressDriverPresets', () => {
	...
	describe('createSqueezeCollectFlow', () => {
		it('it should throw an argumentMissingError when payload is missing', async () => {
			...
			try {
				// Act
				AddressDriverPresets.Presets.createSqueezeCollectFlow(
					undefined as unknown as AddressDriverPresets.SqueezeCollectFlowPayload
				);
			} catch (error: any) {
				// Assert
				assert.equal(error.code, DripsErrorCode.MISSING_ARGUMENT);
		...
		it('should validate the squeezeDrips input', async () => {
			...
			const payload: AddressDriverPresets.SqueezeCollectFlowPayload = {
				userId: '1',
				maxCycles: 1,
				tokenAddress: Wallet.createRandom().address,
				driverAddress: Wallet.createRandom().address,
			...
			// Act
			AddressDriverPresets.Presets.createSqueezeCollectFlow(payload);
		...
		it('should return the expected preset', () => {
			...
			// Act
			const preset = AddressDriverPresets.Presets.createSqueezeCollectFlow(payload);
		...
		it('should return the expected preset when skip receiveDrips is true', () => {
			...
			// Act
			const preset = AddressDriverPresets.Presets.createSqueezeCollectFlow(payload, true, false);
		...
		it('should return the expected preset when skip split is true', () => {
			...
			// Act
			const preset = AddressDriverPresets.Presets.createSqueezeCollectFlow(payload, false, true);
		...
		it('should return the expected preset when skip receiveDrips and split are true', () => {
			...
			// Act
			const preset = AddressDriverPresets.Presets.createSqueezeCollectFlow(payload, true, true);
