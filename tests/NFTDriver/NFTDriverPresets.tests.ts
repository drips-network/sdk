...
describe('NFTDriverPresets', () => {
	...
	describe('createSqueezeCollectFlow', () => {
		it('it should throw an argumentMissingError when payload is missing', async () => {
			// Arrange
			let threw = false;
			...
			try {
				// Act
				NFTDriverPresets.Presets.createSqueezeCollectFlow(
					undefined as unknown as NFTDriverPresets.SqueezeCollectFlowPayload
				);
			} catch (error: any) {
				// Assert
				assert.equal(error.code, DripsErrorCode.MISSING_ARGUMENT);
		...
		it('it should throw an argumentError when token Id is missing from payload', async () => {
			...
			try {
				// Act
				NFTDriverPresets.Presets.createSqueezeCollectFlow({} as NFTDriverPresets.SqueezeCollectFlowPayload);
			} catch (error: any) {
				// Assert
				assert.equal(error.code, DripsErrorCode.INVALID_ARGUMENT);
				threw = true;
		...
		it('should validate the squeezeDrips input', async () => {
			...
			const payload: NFTDriverPresets.SqueezeCollectFlowPayload = {
				tokenId: '200',
				userId: '1',
				maxCycles: 1,
				tokenAddress: Wallet.createRandom().address,
			...
			// Act
			NFTDriverPresets.Presets.createSqueezeCollectFlow(payload);
		...
		it('should return the expected preset', () => {
			...
			// Act
			const preset = NFTDriverPresets.Presets.createSqueezeCollectFlow(payload);
		...
		it('should return the expected preset when skip receiveDrips is true', () => {
			...
			// Act
			const preset = NFTDriverPresets.Presets.createSqueezeCollectFlow(payload, true, false);
		...
		it('should return the expected preset when skip split is true', () => {
			...
			// Act
			const preset = NFTDriverPresets.Presets.createSqueezeCollectFlow(payload, false, true);
		...
		it('should return the expected preset when skip receiveDrips and split are true', () => {
			...
			// Act
			const preset = NFTDriverPresets.Presets.createSqueezeCollectFlow(payload, true, true);
