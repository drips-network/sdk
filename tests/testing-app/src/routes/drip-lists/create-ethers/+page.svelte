...
<div class="info-box">
	...
	This page replicates the "Create Drip List using Ethers" integration test. It will set up an Ethers wallet/signer, 
...
<div class="form-container">
	<div class="form-group">
		...
		<input type="text" id="dripListName" value="Test Drip List (Ethers)" />
	</div>
	
	<div class="form-group">
		<label for="dripListDescription">Description:</label>
		<textarea id="dripListDescription">A test drip list created using Ethers adapter</textarea>
	</div>
...
<div class="form-container">
	<button class="button primary">🚀 Create Drip List with Ethers</button>
</div>
