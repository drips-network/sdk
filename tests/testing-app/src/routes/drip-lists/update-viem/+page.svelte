...
<div class="info-box">
	...
	This page replicates the "Update Drip List using Viem" integration test. It will first create an initial drip list, 
...
<div class="form-container">
	<div class="form-group">
		...
		<input type="text" id="initialDripListName" value="Test Drip List for Update (Viem)" />
	</div>
	
	<div class="form-group">
		<label for="initialDripListDescription">Initial Description:</label>
		<textarea id="initialDripListDescription">Initial drip list to be updated using Viem adapter</textarea>
	</div>
...
<div class="form-container">
	<div class="form-group">
		...
		<input type="text" id="updatedDripListName" value="Updated Test Drip List (Viem)" />
	</div>
	
	<div class="form-group">
		<label for="updatedDripListDescription">Updated Description:</label>
		<textarea id="updatedDripListDescription">Updated drip list description using Viem adapter</textarea>
	</div>
...
<div class="form-container">
	...
	<button class="button primary">🔄 Update Drip List with Viem</button>
</div>
