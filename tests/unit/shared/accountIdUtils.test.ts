...
import {extractOrcidIdFromAccountId} from '../../../src/internal/linked-identities/orcidUtils';
  ...
  describe('extractOrcidIdFromAccountId', () => {
    describe('successful extraction', () => {
      it('should extract ORCID iD from string account ID', () => {
        ...
        const accountId =
          '81320912658542974439730315780315479837099264021654871105585262100480';
      ...
      it('should return null when extraction produces something that does not resemble an ORCID iD', () => {
        ...
        const accountId =
          '80927338512810702724070905882237017022089417038277884279346528518144';
